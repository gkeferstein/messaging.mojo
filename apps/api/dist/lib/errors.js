...
export class NotFoundError extends AppError {
    constructor(resource, id) {
        super('NOT_FOUND', id ? `${resource} mit ID ${id} nicht gefunden` : `${resource} nicht gefunden`, 404);
...
export class ContactRequestRequiredError extends AppError {
    constructor(userId) {
        super('CONTACT_REQUEST_REQUIRED', 'Kontaktanfrage erforderlich', 403, { targetUserId: userId });
